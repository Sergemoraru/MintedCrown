      ...
      <div className="relative bottom-32 flex flex-col justify-center">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
            Welcome to Minted Crown Marketing, where we don't just wear crowns;
            we market them! From crafting majestic campaigns to reigning over
        ...
        <div className="mt-36 lg:mt-44">
          ...
          <ul
            role="list"
            className="mt-8 flex items-center justify-center gap-x-8 pb-10 sm:flex-col sm:gap-x-0 sm:gap-y-10 xl:flex-row xl:gap-x-12 xl:gap-y-0"
          >
            {[
              [
